...
import card7 from '/public/card7.webp'
import card8 from '/public/card8.webp'
import card9 from '/public/card9.webp'
import { cn } from '@/lib/utils'

const SpecialCard = () => {
    return (
        <div className='my-20'>
            <div className='w-[57%] mx-auto rounded-4xl px-4 py-6 border-1 border-gray-200'>
                <BadgeButton>Component Preview</BadgeButton>
                <h2 className='text-black/80 text-center font-bold text-6xl mt-4'>Tailwind + Framer + React</h2>
                <h5 className='text-black/70 text-center font-bold text-3xl mb-8'>Everything you need to ship</h5>
                <SkiperCard
                    step1img1Class={cn(
